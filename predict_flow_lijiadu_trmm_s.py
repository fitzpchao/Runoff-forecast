...
CSV_TRAIN  = "trmm_ljd_m.csv"
CSV_TEST = "trmm_ljd_m.csv"
...
# 进行训练
# 封装之前定义的lstm
regressor = SKCompat(learn.Estimator( model_fn=lstm_model, model_dir="Models/model_trmm_ljd_spc2"))
# 生成数据
...
writer = pd.ExcelWriter('lijiadudongtai.xls')
...
fig.savefig('flow_lijiadu_trmm_s.png')
plt.show()
