...
CSV_TRAIN  = "trmm_mg.csv"
CSV_TEST = "trmm_mg.csv"
...
# 进行训练
# 封装之前定义的lstm
regressor = SKCompat(learn.Estimator(model_fn=lstm_model, model_dir="Models/model_trmm_mg_s_s"))
# 生成数据
...
fig.savefig('flow_meigan_trmm_s_s.png')
plt.show()
